        ...
        <ul class="navbar-nav flex-row align-items-center ms-md-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-icon btn-text-secondary rounded-pill position-relative"
                    href="<?php echo $url_frontend; ?>/index.php?page=chat" title="Bate-papo Interno">
                    <!-- Ícone de mensagens -->
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <?php 
                        // Define o caminho base usando a variável do .env
                        $base_url_avatar = $url_backend . "/routers/avatar/";
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li>
                        <a class="dropdown-item mt-0" href="index.php?page=perfil">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const CHAT_API = '<?php echo $url_backend; ?>/routers/chat_api.php';
