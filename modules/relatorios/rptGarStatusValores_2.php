...
<head>
    ...
    <title>Status e Valores V2 | Sistema GNV</title>
...
<body class="h-full overflow-hidden">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-2xl border shadow-sm">
            <div>
                <h2 class="text-xl font-black text-azul-fiscal uppercase tracking-tighter flex items-center">
                    <i data-lucide="layout-list" class="mr-2 text-verde-recuperacao"></i>
                    Status e Valores (Modelo Paisagem)
                </h2>
                <p class="text-[10px] text-gray-400 font-medium uppercase tracking-widest mt-1">Visão detalhada em colunas</p>
            </div>
        ...
        <div class="flex-1 flex flex-col lg:flex-row gap-6 min-h-0">
            ...
            <aside class="w-full lg:w-80 bg-white rounded-2xl border shadow-sm p-6 flex flex-col shrink-0">
                <form id="filtroForm" class="space-y-4">
                    <h4 class="text-[10px] font-black uppercase text-gray-400 mb-4 tracking-widest">Parâmetros de Busca</h4>
                    <div>
            ...
            <div class="flex-1 bg-slate-100 rounded-2xl border-4 border-white shadow-inner overflow-hidden relative">
                <div id="placeholderView" class="absolute inset-0 flex flex-col items-center justify-center text-gray-400 bg-slate-50">
                    <i data-lucide="monitor-check" class="w-12 h-12 mb-2 opacity-20"></i>
                    <p class="text-sm font-medium">Os dados aparecerão aqui em formato paisagem</p>
                </div>
    ...
    <script>
        ...
        document.getElementById('btnConsultar').addEventListener('click', () => {
            ...
            // Link alterado para o arquivo _2
            iframe.src = `modules/relatorios/rptGarStatusValoresImpressao_2.php?${getUrlParams().toString()}`;
            iframe.onload = () => {
        ...
        function exportarExcel() {
            ...
            window.location.href = `modules/relatorios/rptGarStatusValoresImpressao_2.php?${params.toString()}`;
        }
